...
Uncheck **Locked** to reveal the three translation arrows: red X, green Y, blue Z. Drag an arrow to move along that world axis. Each complete drag is one undoable action. Escape, losing mouse capture, locking, or leaving the view cancels an unfinished drag. Right drag, middle drag, and the wheel retain their camera controls outside a pickup drag.
