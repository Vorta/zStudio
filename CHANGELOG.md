...
- Retain loaded model/Whole world scenes during LOD, horizon and texture-pack refreshes; publish only completed replacements and restore option controls after cancellation or load failure.
