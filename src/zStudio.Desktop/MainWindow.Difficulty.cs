...
public partial class MainWindow
{
    ...
    private async Task RefreshWorldDifficultyAsync()
    {
        ...
        try
        {
            ...
            token.ThrowIfCancellationRequested(); ApplySceneOptions();
            ...
            selectedNode = selection is int index && mission.RemapNodeFrom(previous, index) is >= 0 and int mapped ? mapped : null;
