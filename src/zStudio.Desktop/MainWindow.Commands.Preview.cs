...
public partial class MainWindow
{
    ...
    private void RegisterPreviewCommands(StudioCommands r)
    {
        ...
        Register(r, "camera", "Read or set an upright camera pose, move relative to its viewing basis, rotate, or frame the active scene. Never captures the user's mouse.", true,
            [PreviewParameter, P("action", "string", "Camera operation.", true, "read", "set", "move", "rotate", "frame"), P("position", "array", "Absolute XYZ for set."), P("look", "array", "Look direction XYZ for set."), P("fov", "number", "Horizontal field of view in degrees."), P("right", "number", "Right displacement in game units."), P("up", "number", "World-Y displacement in game units."), P("forward", "number", "Forward displacement in game units."), P("horizontal", "number", "Horizontal mouse-equivalent delta."), P("vertical", "number", "Vertical mouse-equivalent delta.")], a =>
        {
